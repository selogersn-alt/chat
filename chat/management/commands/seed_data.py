...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        partners_list = [
            ...
            ("KING IMMO", "KNG", "778339425", None, "OUAKAM MAMELLES", "VIDE", "NUAGEUX"),
            ("WOURA BUILDING", "WRA", "764372365", None, "DAKAR", "VIDE", "ENSOLEILLE"),
            ...
            ("JAMM IMMO", "JAMM", "761660377", None, "SACREE CŒUR", "VIDE", "NUAGEUX"),
            ("AMB IMMO", "ABM", "778314975", None, "MERMOZ", "VIDE", "NUAGEUX"),
            ("ABM IMMO", "ABM", "773693368", None, "MERMOZ", "VIDE", "ORAGEUX"),
            ...
            ("DJIBRIL IMMO", "DJI", "765999588", None, "SACREE CŒUR", "VIDE", "NUAGEUX"),
            ...
            ("Barry", "bar", "761343074", None, "", "VIDE", "NUAGEUX"),
